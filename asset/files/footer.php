    <footer class="footer-area">
        <div class="container col-grid">
            <div class="row-item">
                <h2>A Propos</h2>
                <p>Polyvalence est un institut privé de formation professionnelle à Salé, la rigueur et la qualité de nos méthodes pédagogiques nous ont valu l’obtention de la qualification et l’accréditation du Ministère de la Formation Professionnelle.</p>
                <ul class="list-icon">
                    <a href="">
                        <li>
            ...
            <div class="row-item">
                ...
                <div class="col-flex">
                    <i></i>
                    <span>sidi moussa sale</span>
                </div>
                <div class="col-flex">
                    <i></i>
                    <a href="tel:+212537781791"><span>+212 537 781 791</span></a>
                </div>
                <div class="col-flex">
                    <i></i>
                    <a href="mailto:Polyvalenceale@gmail.com"><span>Polyvalenceale@gmail.com</span></a>
                </div>
            </div>
        </div>
        <div class="footer-bottom">
            <p>© 2024 x. Tous les droit reservé | x</p>
        </div>
    </footer>